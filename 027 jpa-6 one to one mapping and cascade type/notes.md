...
Inserting a `UserDetails` object that contains a nested `userAddress` object saves both rows and the response contains the IDs of both the parent and child.
